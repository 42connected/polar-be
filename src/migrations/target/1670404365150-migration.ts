...
export class migration1670404365150 implements MigrationInterface {
  name = 'migration1670404365150';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "reports" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "extra_cadets" character varying(500), "place" character varying(100), "topic" character varying(150), "content" character varying(800), "image_url" character varying(1000) array DEFAULT '{}', "signature_url" character varying(1000), "feedback_message" character varying(800), "feedback1" smallint, "feedback2" smallint, "feedback3" smallint, "money" integer, "status" character varying(10) NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "mentors_id" uuid, "cadets_id" uuid, "mentoring_logs_id" uuid, CONSTRAINT "REL_39fc109ddfefdf908d1192bcbc" UNIQUE ("mentoring_logs_id"), CONSTRAINT "PK_d9013193989303580053c0b5ef6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "mentoring_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "meeting_at" TIMESTAMP WITH TIME ZONE array, "meeting_start" TIMESTAMP WITH TIME ZONE, "topic" character varying(100) NOT NULL, "content" character varying(1000) NOT NULL, "status" character varying(10) NOT NULL, "reject_message" character varying(500), "request_time1" TIMESTAMP WITH TIME ZONE array NOT NULL, "request_time2" TIMESTAMP WITH TIME ZONE array, "request_time3" TIMESTAMP WITH TIME ZONE array, "mentors_id" uuid, "cadets_id" uuid, CONSTRAINT "PK_33e90fb8f8903523648041037a4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "cadets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "intra_id" character varying(15) NOT NULL, "name" character varying(10), "profile_image" character varying(1000), "resume_url" character varying(1000), "is_common" boolean NOT NULL, "email" character varying(100) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_f4dfe45a6458152583c442e30cf" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "comments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "content" character varying(300) NOT NULL, "is_deleted" boolean NOT NULL DEFAULT false, "deleted_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "mentors_id" uuid, "cadets_id" uuid, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "mentors" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "intra_id" character varying(50) NOT NULL, "slack_id" character varying(100), "name" character varying(10), "email" character varying(100), "company" character varying(100), "duty" character varying(100), "profile_image" character varying(1000), "available_time" character varying, "introduction" character varying(150), "tags" character varying(150) array, "is_active" boolean NOT NULL, "markdown_content" character varying(10000), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_67a614446eab992e4d0580afebf" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "bocals" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(10), "intra_id" character varying(15) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_fc425bc67545ad0e82ed96e8995" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
